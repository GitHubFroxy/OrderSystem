...
{    
    ...
    styleOn = "border-image: url(:/image/evaluate/star_check.png); border: 0px;";
    styleOff = "border-image: url(:/image/evaluate/star.png); border: 0px;";

    setFixedSize(48,48);            //不允许变化大小
